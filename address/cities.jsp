...
var pb_UrlId='173';
 ...
 function funNext(fun){
  ...
  noCopy:"id",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","display":getDes("id"),"name":"id","width":100,"align":"left"},{"isSort":"false","display":getDes("name"),"name":"name","width":100,"align":"left"},{"isSort":"false","display":getDes("province_id"),"name":"province_id","width":100,"align":"left"},{"isSort":"false","display":getDes("level"),"name":"level","width":100,"align":"left"},{"isSort":"false","display":getDes("zip_code"),"name":"zip_code","width":100,"align":"left"},{"isSort":"false","display":getDes("pinyin"),"name":"pinyin","width":100,"align":"left"},{"isSort":"false","display":getDes("pinyin_abbr"),"name":"pinyin_abbr","width":100,"align":"left"},{"isSort":"false","display":getDes("created_at"),"name":"created_at","width":100,"align":"left"},{"isSort":"false","display":getDes("updated_at"),"name":"updated_at","width":100,"align":"left"}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"173","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"173",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"display":getDes("id"),"name":"id","type":"text"},{"newline":false,"display":getDes("name"),"name":"name","type":"text"},{"newline":false,"display":getDes("province_id"),"name":"province_id","type":"text"},{"newline":false,"display":getDes("level"),"name":"level","type":"text"},{"newline":false,"display":getDes("zip_code"),"name":"zip_code","type":"text"},{"newline":false,"display":getDes("pinyin"),"name":"pinyin","type":"text"},{"newline":false,"display":getDes("pinyin_abbr"),"name":"pinyin_abbr","type":"text"},{"newline":false,"display":getDes("created_at"),"name":"created_at","type":"text"},{"newline":false,"display":getDes("updated_at"),"name":"updated_at","type":"text"}]
	});
	 var obj = {  
province_id:1         
         };
