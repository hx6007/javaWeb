...
$pb.Data.gridSave(pb.manager,tiketMap,"177","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"177",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"display":getDes("pf_id"),"name":"pf_id","type":"text"},{"newline":false,"display":getDes("user_id"),"name":"user_id","type":"text"},{"newline":false,"display":getDes("address"),"name":"address","type":"text"},{"newline":false,"display":getDes("zipcode"),"name":"zipcode","type":"text"},{"newline":false,"display":getDes("consignee"),"name":"consignee","type":"text"},{"newline":false,"display":getDes("telephone"),"name":"telephone","type":"text"},{"newline":false,"display":getDes("phone_number"),"name":"phone_number","type":"text"},{"newline":false,"display":getDes("isflag"),"name":"isflag","type":"text"},{"newline":false,"display":getDes("created_at"),"name":"created_at","type":"text"},{"newline":false,"display":getDes("updated_at"),"name":"updated_at","type":"text"},{"newline":false,"display":getDes("province_id"),"name":"province_id","type":"text"},{"newline":false,"display":getDes("city_id"),"name":"city_id","type":"text"},{"newline":false,"display":getDes("district_id"),"name":"district_id","type":"text"},{"newline":false,"display":getDes("logistics_site"),"name":"logistics_site","type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
