...
$pb.Data.gridSave(pb.manager,tiketMap,"172","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"172",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
