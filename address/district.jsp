...
$pb.Data.gridSave(pb.manager,tiketMap,"174","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"174",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"display":getDes("id"),"name":"id","type":"text"},{"newline":false,"display":getDes("name"),"name":"name","type":"text"},{"newline":false,"display":getDes("city_id"),"name":"city_id","type":"text"},{"newline":false,"display":getDes("pinyin"),"name":"pinyin","type":"text"},{"newline":false,"display":getDes("pinyin_abbr"),"name":"pinyin_abbr","type":"text"},{"newline":false,"display":getDes("created_at"),"name":"created_at","type":"text"},{"newline":false,"display":getDes("updated_at"),"name":"updated_at","type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
