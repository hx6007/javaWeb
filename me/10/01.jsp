...
var pb_UrlId='163';
 ...
 function funNext(fun){
  ...
  noCopy:"id",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"id","display":getDes("id")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"subject","display":getDes("subject")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"user_id","display":getDes("user_id")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"memory_type","display":getDes("memory_type")},{"isSort":"false","editor":{"type":"date",format:"yyyy-MM-dd"}, render:function(item){                   
return $pb.edit.date({item:item,filed:'memory_date',gManage:pb.manager,format:"yyyy-MM-dd"});
                           },type:"date","align":"left","width":150,"name":"memory_date","display":$pb.lang.readDes(langDesMap,'memory_date')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"charge","display":getDes("charge")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"contact","display":getDes("contact")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"remark","display":getDes("remark")}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"163","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"163",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"name":"id","display":getDes("id")},{"newline":false,"name":"subject","display":getDes("subject"),"type":"text"},{"newline":false,"name":"user_id","display":getDes("user_id"),"type":"text"},{"newline":false,"name":"memory_type","display":getDes("memory_type"),"type":"text"},{"newline":false,"name":"memory_date","display":getDes("memory_date"),"type":"text"},{"newline":false,"name":"charge","display":getDes("charge"),"type":"text"},{"newline":false,"name":"contact","display":getDes("contact"),"type":"text"},{"newline":false,"name":"remark","display":getDes("remark"),"type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
