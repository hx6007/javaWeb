...
$pb.Data.gridSave(pb.manager,tiketMap,"179","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"179",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"display":getDes("order_id"),"name":"order_id","type":"text"},{"newline":false,"display":getDes("sku_id"),"name":"sku_id","type":"text"},{"newline":false,"display":getDes("warehouse"),"name":"warehouse","type":"text"},{"newline":false,"display":getDes("count"),"name":"count","type":"text"},{"newline":false,"display":getDes("created_at"),"name":"created_at","type":"text"},{"newline":false,"display":getDes("updated_at"),"name":"updated_at","type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
