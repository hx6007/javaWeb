...
var pb_UrlId='178';
 ...
 function funNext(fun){
  ...
  noCopy:"id",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","display":getDes("id"),"name":"id","width":30,"align":"left"},{"isSort":"false","display":getDes("user_id"),"name":"user_id","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("logistics"),"name":"logistics","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("address_id"),"name":"address_id","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("is_pallet"),"name":"is_pallet","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("is_delay_shipment"),"name":"is_delay_shipment","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("delay_shipment_time"),"name":"delay_shipment_time","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("memo"),"name":"memo","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("created_at"),"name":"created_at","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("updated_at"),"name":"updated_at","width":100,"align":"left"},{"isSort":"false","display":getDes("number"),"name":"number","width":120,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("pick_date"),"name":"pick_date","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("order_date"),"name":"order_date","width":100,"align":"left"}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"178","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"178",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"display":getDes("user_id"),"name":"user_id","type":"text"},{"newline":false,"display":getDes("logistics"),"name":"logistics","type":"text"},{"newline":false,"display":getDes("address_id"),"name":"address_id","type":"text"},{"newline":false,"display":getDes("is_pallet"),"name":"is_pallet","type":"text"},{"newline":false,"display":getDes("is_delay_shipment"),"name":"is_delay_shipment","type":"text"},{"newline":false,"display":getDes("delay_shipment_time"),"name":"delay_shipment_time","type":"text"},{"newline":false,"display":getDes("memo"),"name":"memo","type":"text"},{"newline":false,"display":getDes("created_at"),"name":"created_at","type":"text"},{"newline":false,"display":getDes("updated_at"),"name":"updated_at","type":"text"},{"newline":false,"display":getDes("number"),"name":"number","type":"text"},{"newline":false,"display":getDes("pick_date"),"name":"pick_date","type":"text"},{"newline":false,"display":getDes("order_date"),"name":"order_date","type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
