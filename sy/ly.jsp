...
var pb_UrlId='134';
 ...
 function funNext(fun){
  ...
  noCopy:"Item",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"Item","display":getDes('Item')},{"isSort":"false",type:"date",render:function(item){                          
                              return  $pb.edit.date({item:item,filed:'DateTime',gManage:pb.manager});
                           },"align":"left","width":150,"name":"DateTime","display":getDes('DateTime')},{"isSort":"false","align":"left","width":100,"name":"IP","display":getDes('IP')},{"isSort":"false","align":"left","width":100,"name":"Name","display":getDes('Name')},{"isSort":"false","align":"left","width":100,"name":"TelPhone","display":getDes('TelPhone')},{"isSort":"false",render: function (item){ return $pb.edit.textArea('pb.manager',item,'Message',{edit:false,cols:24,rows:3});},align:"left","width":186,"name":"Message","display":getDes("Message")},{"isSort":"false","render": function (item){
              return $pb.edit.checkEdit('pb.manager', item,'isDo',true  )},"align":"left","width":100,"name":"isDo","display":getDes('isDo')}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"134","Item",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
...
$pb.gridToobar.pageInfo=$pb.clone(parm);
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"134",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"name":"Item","display":getDes('Item')},{"newline":false,"name":"DateTime","display":getDes('DateTime'),"type":"text"},{"newline":false,"name":"IP","display":getDes('IP'),"type":"text"},{"newline":false,"name":"Name","display":getDes('Name'),"type":"text"},{"newline":false,"name":"TelPhone","display":getDes('TelPhone'),"type":"text"},{"newline":false,"name":"Message","display":getDes('Message'),"type":"text"},{"newline":false,"name":"isDo","display":getDes('isDo'),"type":"int"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
