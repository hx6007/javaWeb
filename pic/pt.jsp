...
var pb_UrlId='93';
 ...
 function funNext(fun){
  ...
  noCopy:"ptKey",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"ptKey","display":getDes('ptKey')},{"isSort":"false","align":"left","width":100,"name":"tableName","display":getDes('tableName')},{"isSort":"false","align":"left","width":100,"name":"tabKey","display":getDes('tabKey')},{"isSort":"false","align":"left","width":100,"name":"tabFiled","display":getDes('tabFiled')},{"isSort":"false","align":"left","width":100,"name":"picId","display":getDes('picId')}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"93","ptKey",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
...
$pb.gridToobar.pageInfo=$pb.clone(parm);
      $pb.Data.load(parm,tiketMap,"93",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
