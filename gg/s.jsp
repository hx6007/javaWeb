  ...
  $pb.select.get(["pingtai"],function(sdate){ 
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"pid","display":getDes("pid")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"name","display":getDes("name")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"title","display":getDes("title")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"desc","display":getDes("desc")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"color","display":getDes("color")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"bgcolor","display":getDes("bgcolor")},{"isSort":"false","editor":{"type":"date",format:"yyyy-MM-dd hh:mm:ss",showTime:true}, render:function(item){
                              return $pb.edit.date({item:item,filed:'created_at',gManage:pb.manager});
                           },type:"date","align":"left","width":100,"name":"created_at","display":getDes("created_at")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"updated_at","display":getDes("updated_at")},
{"isSort":"false","editor":{"type":"checkboxlist",css:"back_",rowSize:7,"textField":"text","valueField":"sValue","data":$pb.select.getObj("pingtai").data,split:","},"align":"left","width":600,"name":"site_code","display":getDes('site_code'),render:function(item){
                             var v_=$pb.isNull(item["site_code"],"51etm").split(",");
                             var r_="";
                             $(v_).each(function(i,v){
                                if(i>0){
                                   r_+=",";
                                }
                                r_+=$pb.select.getObj("pingtai").map[v]?$pb.select.getObj("pingtai").map[v][0].text:v;
                             }); 
                             return r_;
                            }
},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"page_style","display":getDes("page_style")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"enabled","display":getDes("enabled")}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"161","pid",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
