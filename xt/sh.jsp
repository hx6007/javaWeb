      ...
      if(typeof fun =="function"){
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"psId","display":getDes('psId')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"pParentId","display":getDes('pParentId')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"pYeId","display":getDes('pYeId')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"pYeType","display":getDes('pYeType')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":300,"name":"pDes","display":getDes('pDes'),id:"id1"}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"110","psId",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"110",$pb.grid.pbCol(pb.cols),function(data){
        			var gridData = {Rows:[],Total:0};
        			if(data.code==0){        				  
        				gridData.Rows=$pb.findTreeMap(data.data,'psId','pParentId');
