...
var pb_UrlId='120';
 ...
 function funNext(fun){
  ...
  noCopy:"id",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"id","display":getDes('id')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"processName","display":getDes('processName')},{"isSort":"false","editor":{"type":"text"},align:"left","width":100,"name":"pAdd","display":getDes('pAdd')},{"isSort":"false",type:"date",render:function(item){                          
                              return  $pb.edit.date({item:item,filed:'new_date',gManage:pb.manager});
                           },"align":"left","width":200,"name":"new_date","display":getDes('new_date')},{"isSort":"false","align":"left","width":100,"name":"pModify","display":getDes('pModify')},{"isSort":"false", render:function(item){
                              return $pb.edit.date({item:item,filed:'modify_date'});
 },"editor":{"type":"date",format:"yyyy-MM-dd hh:mm:ss",showTime:true},type:"date","align":"left","width":200,"name":"modify_date","display":getDes('modify_date')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"note","display":getDes('note')}];
...
,f_initGrid:function(gridData,gridId,pageInfo){
   ...
   pb.theGridData=gridData;
        			var gridInfo={
        	                ...
        	                enabledEdit: true,pageSize:$pb.isNull(pageInfo.page_size,19),pageSizeOptions:[10,19,40,50],
...
$pb.Data.gridSave(pb.manager,tiketMap,"120","id",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
...
$pb.gridToobar.pageInfo=$pb.clone(parm);
      $pb.Data.load(parm,tiketMap,"120",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
