      ...
      if(typeof fun =="function"){
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"tId","display":getDes('tId')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"tRa","display":getDes('tRa')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":300,"name":"tTicket","display":getDes('tTicket')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":200,"name":"tDes","display":getDes('tDes')}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"109","tId",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"109",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
