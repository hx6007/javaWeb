...
function funNext(fun){
  ...
  noCopy:"tId",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left",type:"int","width":100,"name":"tId","display":getDes('tId')},{"isSort":"false","align":"left","width":100,"name":"tName","display":getDes('tName')},{"isSort":"false",render: function (item){
return $pb.edit.checkEdit('pb.manager',item,'isModify',true); },"align":"left","width":100,"name":"isModify","display":getDes('isModify')},{"isSort":"false",render: function (item){
return $pb.edit.checkEdit('pb.manager',item,'isUse',true); },"align":"left","width":100,"name":"isUse","display":getDes('isUse')},{"isSort":"false","align":"left","width":300,"name":"tDes","display":getDes('tDes'),"editor":{"type":"text"}}];
...
,f_initGrid:function(gridData,gridId){
   ...
   var toolBar=[{ text:getDes('高级自定义查询') , click: function(){
          ...
          ,{ line: true },{ text:getDes('一键导入') , click: function(){
var saveing= $.ligerDialog.waitting(getDes('正在导入...'));
...
$pb.Data.gridSave(pb.manager,tiketMap,"108","tId",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"108",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"name":"tId","display":getDes('tId'),"type":"text"},{"newline":false,"name":"tName","display":getDes('tName'),"type":"text"},{"newline":false,"name":"tDes","display":getDes('tDes'),"type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
