...
$pb.Data.gridSave(pb.manager,tiketMap,"100","rId",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"100",$pb.grid.pbCol(pb.cols),function(data){
       				if(data.code==0){
