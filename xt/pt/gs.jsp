      ...
      if(typeof fun =="function"){
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"pComId","display":getDes('pComId')},{"isSort":"false","editor":{"type":"int"},"align":"left","width":100,"name":"num","display":getDes('num')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"comName","display":getDes('comName')}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"88","pComId",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"88",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
