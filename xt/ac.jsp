...
var pb_UrlId='104';
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"aId","display":getDes('aId')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":200,"name":"actionDo","display":getDes('actionDo')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"type","display":getDes('type')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"apandParm","display":getDes('apandParm')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"acDes","display":getDes('acDes')},{"isSort":"false","editor":{"type":"int"},type:"int","align":"left","width":100,"name":"orderNo","display":getDes('orderNo')}];
...
,f_initGrid:function(gridData,gridId){
   pb.theGridData=gridData;
        			var gridInfo={
        	                ...
        	                data: gridData,detailHeight:26,rowHeight:24,
        	                width: '98%' 
        	            };
...
$pb.Data.gridSave(pb.manager,tiketMap,"104","aId",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
parm['add']="order by orderNo";
      $pb.Data.load(parm,tiketMap,"104",$pb.grid.pbCol(pb.cols),function(data){
       				if(data.code==0){
