...
var pb_UrlId='9';
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":200,"name":"text","display":getDes("text"),id:"id1"},{"isSort":"false","align":"left","width":60,"name":"id","display":getDes("id")},{"isSort":"false","align":"left","width":150,"name":"url","display":getDes("url")},{"isSort":"false","align":"left","width":60,"name":"parentId","display":getDes("parentId")},{"isSort":"false","align":"left","width":300,"name":"des","display":getDes("des")}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"9","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"9",$pb.grid.pbCol(pb.cols),function(data){
...
<div style="width: 100%; height: 90%; top:30px;overflow: auto;position: absolute;">
<div id="spanGrid"></div>
