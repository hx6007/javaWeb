...
if(form.valid()){
$pb.Data.gridSave(pb.manager,tiketMap,"149","auditNO",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
}
...
if(count(parm)>2){
       $pb.Data.panLoad(parm,tiketMap,"149",$pb.grid.pbCol(pb_Pan.options.fields),function(data){
       	           if(data.code==0){
...
$pb.panel.readOnly(pb_Pan,["auditNO"]);
    ...
    pb_Pan=$("#panFrom").ligerForm({
        ...
        validate: true,
		space : 2,
		fields :[{"newline":false,"name":"auditMess","display":getDes("auditMess"),"type":"textarea",width:752,validate:{required:true }},{"newline":true,"name":"auditNO","display":getDes("auditNO")},{"newline":false,"name":"pbCode","display":getDes("pbCode"),"type":"text"},{"newline":false,"name":"pbProccesNo","display":getDes("pbProccesNo"),"type":"text"},{"newline":false,"name":"user_id","display":getDes("user_id"),"type":"text",disabled:"true"}]
});
