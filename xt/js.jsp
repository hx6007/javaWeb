      ...
      if(typeof fun =="function"){
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"rId",type:"int","display":getDes("rId")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"rName","display":getDes("rName")}];
...
pb.toobar.removeItem("delete");
        			var gridInfo={
        	                ...
        	                width: '98%' ,checkbox:true,isSingleCheck:true
        	            };
...
$pb.Data.gridSave(pb.manager,tiketMap,"24","rId",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"24",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
