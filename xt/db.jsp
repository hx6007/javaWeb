      ...
      if(typeof fun =="function"){
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"dataId","display":getDes("dataId")},{"isSort":"false",render: function (item){ return $pb.edit.textArea('pb.manager',item,'user',{edit:true,cols:24,rows:3}); },"align":"left","width":240,"name":"user","display":getDes("user")},{"isSort":"false",render: function (item){ return $pb.edit.textArea('pb.manager',item,'password',{edit:true,cols:24,rows:3}); },"align":"left","width":240,"name":"password","display":getDes("password")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"dbIp","display":getDes("dbIp")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"dbPort","display":getDes("dbPort")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"dbName","display":getDes("dbName")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"dbCode","display":getDes("dbCode")}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"156","dataId",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"156",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
