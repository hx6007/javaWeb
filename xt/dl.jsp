...
var pb_UrlId='84';
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"langId","display":getDes('langId')},
{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"lang","display":getDes('lang')},
{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"langdes","display":getDes('langdes')},
{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"shouming","display":getDes('shouming')}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"/lang.do","langId",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"/lang.do",$pb.grid.pbCol(pb.cols),function(data){
       				if(data.code==0){
$pb.lang.load(langNo,tiketMap,loadMenu(data));
