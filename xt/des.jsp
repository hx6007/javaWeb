...
var pb_UrlId='85';
 ...
 function funNext(fun){
  ...
  noCopy:"sKey",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"sKey","display":getDes('sKey')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"uId","display":getDes('uId')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"desKey","display":getDes('desKey')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"des","display":getDes('des')}];
...
return pb.cols;
        		    ...
        		    if(pb.initValue==null){
	        		  pb.initValue=$pb.grid.initRow(pb.getCols());
                            ...
                            var pa=$pb.panel.getData(pb_Pan);
                            pb.initValue["uId"]=pa["uId"];
...
$pb.Data.gridSave(pb.manager,tiketMap,"/des.do","sKey",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
var parm=$pb.lang.getlangMap(langNo,langNoC);
 ...
 if(i=="uId"){
     parmMap["ifnull(uId,'')"]=n;       
      }
}
   });
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"/des.do",$pb.grid.pbCol(pb.cols),function(data){
       				if(data.code==0){
...
if(load==0){
       pb_Pan=$("#panFrom").ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"name":"sKey","display":getDes('sKey')},{"newline":false,"name":"uId","display":getDes('uId'),"type":"text"},{"newline":false,"name":"desKey","display":getDes('desKey'),"type":"text"},{"newline":false,"name":"des","display":getDes('des'),"type":"text"}]
	});
	 var obj = {           
         };
if(parmParent.isHas()){
        $pb.mergeMap(obj,parmParent.get());
}	
         pb_Pan.setData(obj);
   load=1;
}
