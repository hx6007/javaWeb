      ...
      if(typeof fun =="function"){
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"w_yid","display":getDes("w_yid")},{ display:getDes('w_pic'), isSort: false, width: 80, render: function (item){   
      return $pb.Data.loadPic(item.w_yid,60,"lb_w_pic",6,'w_pic'+item.__index,item);
}},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"w_des","display":getDes("w_des")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"w_toSrc","display":getDes("w_toSrc")}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"166","w_yid",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
