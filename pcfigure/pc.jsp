...
var type=$pb.getQueryString("type");
function funNext(fun){
  $pb.select.get(["pingtai","doctype"],function(sdate){ 
  ...
  noCopy:"Cid",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","display":getDes("Cid"),"name":"Cid","width":100,"align":"left"},{"isSort":"false","editor":{ type: 'select', data: $pb.select.getObj("pingtai").data, valueField: 'sValue' },
    render: function (item){
                        return $pb.select.getObj("pingtai").map[$pb.isNull(item.platform,'51etm')][0].text;
    },"align":"left","width":100,"name":"platform","display":getDes('platform')},{"isSort":"false","editor":{"type":"text"},"display":getDes("cfname"),"name":"cfname","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("CfontColour"),"name":"CfontColour","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes("Ccolor"),"name":"Ccolor","width":100,"align":"left"},{ display:getDes('CMap'), isSort: false, width: 300, render: function (item){   
      return $pb.Data.loadPic(item.Cid,58,"Cbmap",1,'CMap'+item.__index);
}},{"isSort":"false","display":getDes("doctype"),"name":"doctype","width":100,"align":"left",hide:"1",value:type}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"164","Cid",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"164",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
