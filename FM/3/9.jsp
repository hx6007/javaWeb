...
function funNext(fun){
  $pb.select.get(["zhType"],function(sdate){      
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","render": function (item){
              return $pb.edit.checkEdit('pb.manager', item,'pbOk',true  )},"align":"left","width":40,"name":"pbOk","display":getDes("pbOk"),frozen: true},{"isSort":"false","align":"left","width":100,"name":"zhNo","display":getDes("zhNo")},{"isSort":"false","editor":{ type: 'select', data: $pb.select.getObj("zhType").data, valueField: 'sValue' },
    render: function (item){
                        return $pb.select.getObj("zhType").map[$pb.isNull(item.zhType,0)][0].text;
    },"align":"left","width":100,"name":"zhType","display":getDes('zhType')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"zhName","display":getDes("zhName")},{"isSort":"false","align":"left","width":100,"name":"zhMoney","display":getDes("zhMoney")},{"isSort":"false","align":"left","width":100,"name":"zhZhiMoney","display":getDes("zhZhiMoney")},{"isSort":"false", render: function (item){
                        return $pb.isNull(item.zhMoney,0)-$pb.isNull(item.zhZhiMoney,0);
    },"align":"left","width":100,"display":getDes("zhYu")},{"isSort":"false", render: function (item){
var tem=getDes("详情");
var h="&nbsp;"+$pb.edit.import_(function(){
imp.title="账户："+item.zhName+":"+tem;
parmaMap={};
parmaMap["initValue"]={
"accoutId":item.zhNo
};
parmaMap["panelMap"]={
"accoutId":item.zhNo
};},'','FM/3/10.jsp','','',false,tem);
                        return h;
    },"align":"left","width":100,"display":getDes("caozuo")}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"159","zhNo",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
