...
var pb_UrlId='188';
 ...
 function funNext(fun){
  ...
  noCopy:"id",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":30,"name":"id","display":getDes("id")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"name","display":getDes("name")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"active","display":getDes("active")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"created_at","display":getDes("created_at")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"updated_at","display":getDes("updated_at")}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"188","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"188",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"name":"name","display":getDes("name"),"type":"text"},{"newline":false,"name":"active","display":getDes("active"),"type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
