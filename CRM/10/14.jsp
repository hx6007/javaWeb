...
var pb_UrlId='162';
 ...
 function funNext(fun){
  ...
  noCopy:"Item",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":100,"name":"ctoId","display":getDes("ctoId"),hide:"true"},{"isSort":"false","align":"left","width":100,"name":"Cltcode","display":getDes("Cltcode")},{"isSort":"false","align":"left","width":100,"name":"Salesman","display":getDes("Salesman")},{"isSort":"false", 
...
$pb.Data.gridSave(pb.manager,tiketMap,"162","Item",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
...
$(["add","delete","copyRow","save","nextOk","saveOk"]).each(function(i,v){												
    pb.toobar.removeItem(v);
      ...
      $pb.Data.load(parm,tiketMap,"162",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{newline:false,name:"ctoId",display:getDes("ctoId"),type:"text"},{newline:false,name:"Cltcode",display:getDes("Cltcode"),type:"text"},{newline:false,name:"Salesman",display:getDes("Salesman"),type:"text"},{name:"Getdate",display:getDes("Getdate"),type:"date",group:"时间",groupicon:"/manage/images/group/group.gif",oldtype:"text"},{name:"Backdate",display:getDes("Backdate"),type:"date",newline:false,oldtype:"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
