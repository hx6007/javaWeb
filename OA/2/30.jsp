...
if(form.valid()){
$pb.Data.gridSave(pb.manager,tiketMap,"2030","DocCode",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
}
...
if(count(parm)>2){
       $pb.Data.panLoad(parm,tiketMap,"2030",$pb.grid.pbCol(pb_Pan.options.fields),function(data){
       	           if(data.code==0){
...
validate: true,
			space : 2,
			fields : [{"newline":false,"name":"DocCode","display":getDes('DocCode')},{"newline":false,"name":"FormID","display":getDes('FormID'),"type":"int"},{"newline":false,"name":"DocDate","display":getDes('DocDate'),"type":"text"},{"newline":false,"name":"PeriodID","display":getDes('PeriodID'),"type":"text"},{"newline":false,"name":"CreateCode","display":getDes('CreateCode'),"type":"text"},{"newline":false,"name":"CreateName","display":getDes('CreateName'),"type":"text"},{"newline":false,"name":"ComanyId","display":getDes('ComanyId'),"type":"text"},{"newline":false,"name":"ComanyName","display":getDes('ComanyName'),"type":"text"},{"newline":false,"name":"ccName","display":getDes('ccName'),"type":"text"},{"newline":false,"name":"UserName","display":getDes('UserName'),"type":"text"},{"newline":false,"name":"CrewName","display":getDes('CrewName'),"type":"text"},{"newline":false,"name":"Position","display":getDes('Position'),"type":"text"},{"newline":false,"name":"DocType","display":getDes('DocType'),"type":"text"},{"newline":false,"name":"DocStatus","display":getDes('DocStatus'),"type":"int"},{"newline":false,"name":"DocStatusName","display":getDes('DocStatusName'),"type":"text"},{"newline":false,"name":"ReportType","display":getDes('ReportType'),"type":"text"},{"newline":false,"name":"ReportTime","display":getDes('ReportTime'),"type":"text"},{"newline":false,"name":"Work_perf","display":getDes('Work_perf'),"type":"text"},{"newline":false,"name":"Work_pro","display":getDes('Work_pro'),"type":"text"},{"newline":false,"name":"Work_sug","display":getDes('Work_sug'),"type":"text"},{"newline":false,"name":"Work_plan","display":getDes('Work_plan'),"type":"text"},{"newline":false,"name":"CheckerCode","display":getDes('CheckerCode'),"type":"text"},{"newline":false,"name":"CheckerName","display":getDes('CheckerName'),"type":"text"},{"newline":false,"name":"Blscrap","display":getDes('Blscrap'),"type":"text"},{"newline":false,"name":"PrintNum","display":getDes('PrintNum'),"type":"int"},{"newline":false,"name":"LastprintFormid","display":getDes('LastprintFormid'),"type":"int"},{"newline":false,"name":"LastprintDocstatus","display":getDes('LastprintDocstatus'),"type":"text"},{"newline":false,"name":"PostValues1","display":getDes('PostValues1'),"type":"text"},{"newline":false,"name":"PostName1","display":getDes('PostName1'),"type":"text"},{"newline":false,"name":"PostDate1","display":getDes('PostDate1'),"type":"text"},{"newline":false,"name":"PostValues2","display":getDes('PostValues2'),"type":"text"},{"newline":false,"name":"PostName2","display":getDes('PostName2'),"type":"text"},{"newline":false,"name":"PostDate2","display":getDes('PostDate2'),"type":"text"},{"newline":false,"name":"PostValues3","display":getDes('PostValues3'),"type":"text"},{"newline":false,"name":"PostName3","display":getDes('PostName3'),"type":"text"},{"newline":false,"name":"PostDate3","display":getDes('PostDate3'),"type":"text"}]
	});
         pb.loadUrlData();
