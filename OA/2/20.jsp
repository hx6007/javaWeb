...
var pb_UrlId='2020';
 ...
 function funNext(fun){
  ...
  noCopy:"id",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"HrCode","display":getDes('HrCode')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"HrName","display":getDes('HrName')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"ComanyId","display":getDes('ComanyId')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"ComanyName","display":getDes('ComanyName')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"ccCname","display":getDes('ccCname')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"CrewName","display":getDes('CrewName')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"UserName","display":getDes('UserName')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"Position","display":getDes('Position')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"TelPhone","display":getDes('TelPhone')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"Internal_line","display":getDes('Internal_line')},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"WeChat","display":getDes('WeChat')}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"2020","id",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"2020",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"name":"HrCode","display":getDes('HrCode'),"type":"text"},{"newline":false,"name":"HrName","display":getDes('HrName'),"type":"text"},{"newline":false,"name":"ComanyId","display":getDes('ComanyId'),"type":"text"},{"newline":false,"name":"ComanyName","display":getDes('ComanyName'),"type":"text"},{"newline":false,"name":"ccCname","display":getDes('ccCname'),"type":"text"},{"newline":false,"name":"CrewName","display":getDes('CrewName'),"type":"text"},{"newline":false,"name":"UserName","display":getDes('UserName'),"type":"text"},{"newline":false,"name":"Position","display":getDes('Position'),"type":"text"},{"newline":false,"name":"TelPhone","display":getDes('TelPhone'),"type":"text"},{"newline":false,"name":"Internal_line","display":getDes('Internal_line'),"type":"text"},{"newline":false,"name":"WeChat","display":getDes('WeChat'),"type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
