...
$pb.Data.gridSave(pb.manager,tiketMap,"171","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"display":getDes("user_id"),"name":"user_id","type":"text"},{"newline":false,"display":getDes("sku_id"),"name":"sku_id","type":"text"},{"newline":false,"display":getDes("created_at"),"name":"created_at","type":"text"},{"newline":false,"display":getDes("updated_at"),"name":"updated_at","type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
