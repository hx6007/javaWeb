...
if(form.valid()){
$pb.Data.gridSave(pb.manager,tiketMap,"1082","DocCode",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
}
...
if(count(parm)>2){
       $pb.Data.panLoad(parm,tiketMap,"1082",$pb.grid.pbCol(pb_Pan.options.fields),function(data){
       	           if(data.code==0){
...
validate: true,
			space : 2,
			fields : [{"newline":false,"name":"DocCode","display":getDes('DocCode')},{"newline":false,"name":"FormID","display":getDes('FormID'),"type":"int"},{"newline":false,"name":"DocDate","display":getDes('DocDate'),"type":"text"},{"newline":false,"name":"PeriodID","display":getDes('PeriodID'),"type":"text"},{"newline":false,"name":"HrName","display":getDes('HrName'),"type":"text"},{"newline":false,"name":"HrCode","display":getDes('HrCode'),"type":"text"},{"newline":false,"name":"ccName","display":getDes('ccName'),"type":"text"},{"newline":false,"name":"UserName","display":getDes('UserName'),"type":"text"},{"newline":false,"name":"CrewName","display":getDes('CrewName'),"type":"text"},{"newline":false,"name":"Position","display":getDes('Position'),"type":"text"},{"newline":false,"name":"ResidenceType","display":getDes('ResidenceType'),"type":"text"},{"newline":false,"name":"InsuranceType","display":getDes('InsuranceType'),"type":"text"},{"newline":false,"name":"HireDate","display":getDes('HireDate'),"type":"text"},{"newline":false,"name":"DocType","display":getDes('DocType'),"type":"text"},{"newline":false,"name":"DocStatus","display":getDes('DocStatus'),"type":"int"},{"newline":false,"name":"DocStatusName","display":getDes('DocStatusName'),"type":"text"},{"newline":false,"name":"ComanyId","display":getDes('ComanyId'),"type":"text"},{"newline":false,"name":"ComanyName","display":getDes('ComanyName'),"type":"text"},{"newline":false,"name":"ModifyName","display":getDes('ModifyName'),"type":"text"},{"newline":false,"name":"ModifyDate","display":getDes('ModifyDate'),"type":"text"},{"newline":false,"name":"CreateCode","display":getDes('CreateCode'),"type":"text"},{"newline":false,"name":"CreateName","display":getDes('CreateName'),"type":"text"},{"newline":false,"name":"CheckerCode","display":getDes('CheckerCode'),"type":"text"},{"newline":false,"name":"CheckerName","display":getDes('CheckerName'),"type":"text"},{"newline":false,"name":"Blscrap","display":getDes('Blscrap'),"type":"text"},{"newline":false,"name":"PrintNum","display":getDes('PrintNum'),"type":"int"},{"newline":false,"name":"LastprintFormid","display":getDes('LastprintFormid'),"type":"int"},{"newline":false,"name":"LastprintDocstatus","display":getDes('LastprintDocstatus'),"type":"text"},{"newline":false,"name":"BasicSalary1","display":getDes('BasicSalary1'),"type":"text"},{"newline":false,"name":"BasicSalary2","display":getDes('BasicSalary2'),"type":"text"},{"newline":false,"name":"BasicSalary_Date","display":getDes('BasicSalary_Date'),"type":"text"},{"newline":false,"name":"T_Allowance1","display":getDes('T_Allowance1'),"type":"text"},{"newline":false,"name":"T_Allowance2","display":getDes('T_Allowance2'),"type":"text"},{"newline":false,"name":"T_Allowance_Date","display":getDes('T_Allowance_Date'),"type":"text"},{"newline":false,"name":"P_Allowance1","display":getDes('P_Allowance1'),"type":"text"},{"newline":false,"name":"P_Allowance2","display":getDes('P_Allowance2'),"type":"text"},{"newline":false,"name":"P_Allowance_Date","display":getDes('P_Allowance_Date'),"type":"text"},{"newline":false,"name":"WA_Allowance1","display":getDes('WA_Allowance1'),"type":"text"},{"newline":false,"name":"WA_Allowance2","display":getDes('WA_Allowance2'),"type":"text"},{"newline":false,"name":"WA_Allowance_Date","display":getDes('WA_Allowance_Date'),"type":"text"},{"newline":false,"name":"O_Allowance1","display":getDes('O_Allowance1'),"type":"text"},{"newline":false,"name":"O_Allowance2","display":getDes('O_Allowance2'),"type":"text"},{"newline":false,"name":"O_Allowance_Date","display":getDes('O_Allowance_Date'),"type":"text"},{"newline":false,"name":"Remarks","display":getDes('Remarks'),"type":"text"},{"newline":false,"name":"PostValues","display":getDes('PostValues'),"type":"text"},{"newline":false,"name":"PostName","display":getDes('PostName'),"type":"text"},{"newline":false,"name":"PostDate","display":getDes('PostDate'),"type":"text"}]
	});
         pb.loadUrlData();
