...
<link href="<%=path%>/js/Source/lib/ligerUI/skins/Gray/css/all.css" rel="stylesheet" type="text/css" />
...
if(form.valid()){
$pb.Data.gridSave(pb.manager,tiketMap,"1010","ccCode",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
}
...
if(count(parm)>2){
       $pb.Data.panLoad(parm,tiketMap,"1010",$pb.grid.pbCol(pb_Pan.options.fields),function(data){
       	           if(data.code==0){
       				    pb_Pan.setData(data.data);                                   
                     }  
      });	
       }
pb_Pan.setEnabled("ccCode",false);
}
 }; 
function yeLoad(){
...
validate: true,
			space : 2,
			fields : [{"newline":false,"name":"ccCode","display":getDes('ccCode')},{"newline":false,"name":"ccName","display":getDes('ccName'),"type":"text"},{"newline":false,"name":"CompanyID","display":getDes('CompanyID'),"type":"text"},{"newline":false,"name":"HrCode1","display":getDes('HrCode1'),"type":"int"},{"newline":false,"name":"UserCode1","display":getDes('UserCode1'),"type":"text"},{"newline":false,"name":"HrName1","display":getDes('HrName1'),"type":"text"},{"newline":false,"name":"HrCode2","display":getDes('HrCode2'),"type":"int"},{"newline":false,"name":"UserCode2","display":getDes('UserCode2'),"type":"text"},{"newline":false,"name":"HrName2","display":getDes('HrName2'),"type":"text"},{"newline":false,"name":"HrCode3","display":getDes('HrCode3'),"type":"int"},{"newline":false,"name":"UserCode3","display":getDes('UserCode3'),"type":"text"},{"newline":false,"name":"HrName3","display":getDes('HrName3'),"type":"text"},{"newline":false,"name":"Remarks","display":getDes('Remarks'),"type":"text"}]
	});
         pb.loadUrlData();
