...
if(form.valid()){
$pb.Data.gridSave(pb.manager,tiketMap,"1100","DocCode",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
}
...
if(count(parm)>2){
       $pb.Data.panLoad(parm,tiketMap,"1100",$pb.grid.pbCol(pb_Pan.options.fields),function(data){
       	           if(data.code==0){
...
validate: true,
			space : 2,
			fields : [{"newline":false,"name":"DocCode","display":getDes('DocCode')},{"newline":false,"name":"FormID","display":getDes('FormID'),"type":"int"},{"newline":false,"name":"DocDate","display":getDes('DocDate'),"type":"text"},{"newline":false,"name":"PeriodID","display":getDes('PeriodID'),"type":"text"},{"newline":false,"name":"CreateCode","display":getDes('CreateCode'),"type":"text"},{"newline":false,"name":"CreateName","display":getDes('CreateName'),"type":"text"},{"newline":false,"name":"RefCode","display":getDes('RefCode'),"type":"text"},{"newline":false,"name":"RefCode2","display":getDes('RefCode2'),"type":"text"},{"newline":false,"name":"ApplyJob","display":getDes('ApplyJob'),"type":"text"},{"newline":false,"name":"Aapplicant","display":getDes('Aapplicant'),"type":"text"},{"newline":false,"name":"Age","display":getDes('Age'),"type":"int"},{"newline":false,"name":"Gender","display":getDes('Gender'),"type":"text"},{"newline":false,"name":"Education","display":getDes('Education'),"type":"text"},{"newline":false,"name":"NativePlace","display":getDes('NativePlace'),"type":"text"},{"newline":false,"name":"TelPhone","display":getDes('TelPhone'),"type":"text"},{"newline":false,"name":"Source","display":getDes('Source'),"type":"text"},{"newline":false,"name":"Remarks","display":getDes('Remarks'),"type":"text"},{"newline":false,"name":"DocType","display":getDes('DocType'),"type":"text"},{"newline":false,"name":"DocStatus","display":getDes('DocStatus'),"type":"int"},{"newline":false,"name":"DocStatusName","display":getDes('DocStatusName'),"type":"text"},{"newline":false,"name":"ComanyId","display":getDes('ComanyId'),"type":"text"},{"newline":false,"name":"ComanyName","display":getDes('ComanyName'),"type":"text"},{"newline":false,"name":"ModifyName","display":getDes('ModifyName'),"type":"text"},{"newline":false,"name":"ModifyDate","display":getDes('ModifyDate'),"type":"text"},{"newline":false,"name":"CheckerCode","display":getDes('CheckerCode'),"type":"text"},{"newline":false,"name":"CheckerName","display":getDes('CheckerName'),"type":"text"},{"newline":false,"name":"Blscrap","display":getDes('Blscrap'),"type":"text"},{"newline":false,"name":"PrintNum","display":getDes('PrintNum'),"type":"int"},{"newline":false,"name":"LastprintFormid","display":getDes('LastprintFormid'),"type":"int"},{"newline":false,"name":"LastprintDocstatus","display":getDes('LastprintDocstatus'),"type":"text"},{"newline":false,"name":"Interviewer1","display":getDes('Interviewer1'),"type":"text"},{"newline":false,"name":"InterviewTime1","display":getDes('InterviewTime1'),"type":"text"},{"newline":false,"name":"InterviewAddress1","display":getDes('InterviewAddress1'),"type":"text"},{"newline":false,"name":"InterviewResult1","display":getDes('InterviewResult1'),"type":"text"},{"newline":false,"name":"PostValues1","display":getDes('PostValues1'),"type":"text"},{"newline":false,"name":"PostName1","display":getDes('PostName1'),"type":"text"},{"newline":false,"name":"PostDate1","display":getDes('PostDate1'),"type":"text"},{"newline":false,"name":"Interviewer2","display":getDes('Interviewer2'),"type":"text"},{"newline":false,"name":"InterviewTime2","display":getDes('InterviewTime2'),"type":"text"},{"newline":false,"name":"InterviewAddress2","display":getDes('InterviewAddress2'),"type":"text"},{"newline":false,"name":"InterviewResult2","display":getDes('InterviewResult2'),"type":"text"},{"newline":false,"name":"PostValues2","display":getDes('PostValues2'),"type":"text"},{"newline":false,"name":"PostName2","display":getDes('PostName2'),"type":"text"},{"newline":false,"name":"PostDate2","display":getDes('PostDate2'),"type":"text"}]
	});
         pb.loadUrlData();
