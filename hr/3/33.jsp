...
if(form.valid()){
$pb.Data.gridSave(pb.manager,tiketMap,"1033","DocCode",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
}
...
if(count(parm)>2){
       $pb.Data.panLoad(parm,tiketMap,"1033",$pb.grid.pbCol(pb_Pan.options.fields),function(data){
       	           if(data.code==0){
