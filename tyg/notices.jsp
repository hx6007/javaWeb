...
var pb_UrlId='180';
 ...
 function funNext(fun){
  ...
  noCopy:"id",
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","display":getDes('category_id'),"name":"category_id","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes('category_image'),"name":"category_image","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes('category_desc'),"name":"category_desc","width":100,"align":"left"},{"isSort":"false","editor":{"type":"int"},"display":getDes('sort_order'),"name":"sort_order","width":100,"align":"left"},{"isSort":"false","editor":{"type":"int"},"display":getDes('is_show'),"name":"is_show","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes('row_id'),"name":"row_id","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes('parent_row_id'),"name":"parent_row_id","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes('tree_row_id'),"name":"tree_row_id","width":100,"align":"left"},{"isSort":"false","editor":{"type":"int"},"display":getDes('add_time'),"name":"add_time","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes('category_name'),"name":"category_name","width":100,"align":"left"},{"isSort":"false","editor":{"type":"text"},"display":getDes('measure_unit'),"name":"measure_unit","width":100,"align":"left"}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"180","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"180",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{"newline":false,"display":getDes('category_id'),"name":"category_id"},{"newline":false,"display":getDes('category_image'),"name":"category_image","type":"text"},{"newline":false,"display":getDes('category_desc'),"name":"category_desc","type":"text"},{"newline":false,"display":getDes('sort_order'),"name":"sort_order","type":"int"},{"newline":false,"display":getDes('is_show'),"name":"is_show","type":"int"},{"newline":false,"display":getDes('row_id'),"name":"row_id","type":"text"},{"newline":false,"display":getDes('parent_row_id'),"name":"parent_row_id","type":"text"},{"newline":false,"display":getDes('tree_row_id'),"name":"tree_row_id","type":"text"},{"newline":false,"display":getDes('add_time'),"name":"add_time","type":"int"},{"newline":false,"display":getDes('category_name'),"name":"category_name","type":"text"},{"newline":false,"display":getDes('measure_unit'),"name":"measure_unit","type":"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
