...
$pb.Data.gridSave(pb.manager,tiketMap,"181","category_id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"181",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
