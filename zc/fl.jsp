      ...
      if(typeof fun =="function"){
        ...
        pb={
        		...
        		initValue:null,
                        ...
                        refField:{},
        		getCols:function(d_){
                           pb.cols=[{"isSort":"false","align":"left","width":400,"name":"category_id","display":getDes("category_id")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"category_desc","display":getDes("category_desc")},{"isSort":"false","editor":{"type":"int"},"align":"left","width":100,"name":"sort_order","display":getDes("sort_order")},{"isSort":"false","editor":{"type":"int"},"align":"left","width":100,"name":"is_show","display":getDes("is_show")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"row_id","display":getDes("row_id")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"parent_row_id","display":getDes("parent_row_id")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"tree_row_id","display":getDes("tree_row_id")},{"isSort":"false","editor":{"type":"int"},"align":"left","width":100,"name":"add_time","display":getDes("add_time")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"category_name","display":getDes("category_name")},{"isSort":"false","editor":{"type":"text"},"align":"left","width":100,"name":"measure_unit","display":getDes("measure_unit")}];
...
$pb.Data.gridSave(pb.manager,tiketMap,"/category/fl.do","category_id",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
      ...
      $pb.Data.load(parm,tiketMap,"/category/fl.do",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
