...
$pb.Data.gridSave(pb.manager,tiketMap,"175","id",pb.loadUrlData,$pb.lang.getlangMap(langNo,langNoC));
...
if(parmParent.isHas()){
     ...
     $pb.mergeMap(parm,parmMap);
      $pb.Data.load(parm,tiketMap,"175",$pb.grid.pbCol(pb.getCols()),function(data){
       				if(data.code==0){
...
$("#panFrom1").html('<span id="'+saveFrom+'"></span>');
       pb_Pan=$("#"+saveFrom).ligerForm({
			...
			labelAlign:"right",
			space : 2,
			fields : [{newline:false,display:getDes("name"),name:"name",type:"text"},{newline:false,display:getDes("host_name"),name:"host_name",type:"text"},{newline:false,display:getDes("site_code"),name:"site_code",type:"text"},{newline:false,display:getDes("created_at"),name:"created_at",type:"text"},{newline:false,display:getDes("updated_at"),name:"updated_at",type:"text"}]
	});
	 var obj = {           
         };
	if(parmParent.isHas()){
