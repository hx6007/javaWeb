...
if(form.valid()){
$pb.Data.gridSave(pb.manager,tiketMap,"1050","DocCode",pb.loadUrlData(),$pb.lang.getlangMap(langNo,langNoC));
}
...
if(count(parm)>2){
       $pb.Data.panLoad(parm,tiketMap,"1050",$pb.grid.pbCol(pb_Pan.options.fields),function(data){
       	           if(data.code==0){
...
validate: true,
			space : 2,
			fields : [{"newline":false,"name":"DocCode","display":getDes('DocCode')},{"newline":false,"name":"FormID","display":getDes('FormID'),"type":"int"},{"newline":false,"name":"DocDate","display":getDes('DocDate'),"type":"text"},{"newline":false,"name":"PeriodID","display":getDes('PeriodID'),"type":"text"},{"newline":false,"name":"ApplyMen","display":getDes('ApplyMen'),"type":"text"},{"newline":false,"name":"ApplyDept","display":getDes('ApplyDept'),"type":"text"},{"newline":false,"name":"DocType","display":getDes('DocType'),"type":"text"},{"newline":false,"name":"DocStatus","display":getDes('DocStatus'),"type":"int"},{"newline":false,"name":"DocStatusName","display":getDes('DocStatusName'),"type":"text"},{"newline":false,"name":"ComanyId","display":getDes('ComanyId'),"type":"text"},{"newline":false,"name":"ComanyName","display":getDes('ComanyName'),"type":"text"},{"newline":false,"name":"ModifyName","display":getDes('ModifyName'),"type":"text"},{"newline":false,"name":"ModifyDate","display":getDes('ModifyDate'),"type":"text"},{"newline":false,"name":"CreateCode","display":getDes('CreateCode'),"type":"text"},{"newline":false,"name":"CreateName","display":getDes('CreateName'),"type":"text"},{"newline":false,"name":"CheckerCode","display":getDes('CheckerCode'),"type":"text"},{"newline":false,"name":"CheckerName","display":getDes('CheckerName'),"type":"text"},{"newline":false,"name":"Blscrap","display":getDes('Blscrap'),"type":"text"},{"newline":false,"name":"PrintNum","display":getDes('PrintNum'),"type":"int"},{"newline":false,"name":"LastprintFormid","display":getDes('LastprintFormid'),"type":"int"},{"newline":false,"name":"LastprintDocstatus","display":getDes('LastprintDocstatus'),"type":"text"},{"newline":false,"name":"HrName","display":getDes('HrName'),"type":"text"},{"newline":false,"name":"HrCode","display":getDes('HrCode'),"type":"text"},{"newline":false,"name":"ccName","display":getDes('ccName'),"type":"text"},{"newline":false,"name":"CrewName","display":getDes('CrewName'),"type":"text"},{"newline":false,"name":"UserName","display":getDes('UserName'),"type":"text"},{"newline":false,"name":"Position","display":getDes('Position'),"type":"text"},{"newline":false,"name":"HireDate","display":getDes('HireDate'),"type":"text"},{"newline":false,"name":"LeaveDate","display":getDes('LeaveDate'),"type":"text"},{"newline":false,"name":"TelPhone","display":getDes('TelPhone'),"type":"text"},{"newline":false,"name":"Reason","display":getDes('Reason'),"type":"text"},{"newline":false,"name":"AgreeDate","display":getDes('AgreeDate'),"type":"text"},{"newline":false,"name":"opinion1","display":getDes('opinion1'),"type":"text"},{"newline":false,"name":"HandoverCode","display":getDes('HandoverCode'),"type":"text"},{"newline":false,"name":"HandoverName","display":getDes('HandoverName'),"type":"text"},{"newline":false,"name":"PostName1","display":getDes('PostName1'),"type":"text"},{"newline":false,"name":"PostValues1","display":getDes('PostValues1'),"type":"text"},{"newline":false,"name":"PostDate1","display":getDes('PostDate1'),"type":"text"},{"newline":false,"name":"opinion2","display":getDes('opinion2'),"type":"text"},{"newline":false,"name":"PostName2","display":getDes('PostName2'),"type":"text"},{"newline":false,"name":"PostValues2","display":getDes('PostValues2'),"type":"text"},{"newline":false,"name":"PostDate2","display":getDes('PostDate2'),"type":"text"},{"newline":false,"name":"opinion3","display":getDes('opinion3'),"type":"text"},{"newline":false,"name":"PostName3","display":getDes('PostName3'),"type":"text"},{"newline":false,"name":"PostValues3","display":getDes('PostValues3'),"type":"text"},{"newline":false,"name":"PostDate3","display":getDes('PostDate3'),"type":"text"},{"newline":false,"name":"opinion4","display":getDes('opinion4'),"type":"text"},{"newline":false,"name":"PostName4","display":getDes('PostName4'),"type":"text"},{"newline":false,"name":"PostValues4","display":getDes('PostValues4'),"type":"text"},{"newline":false,"name":"PostDate4","display":getDes('PostDate4'),"type":"text"},{"newline":false,"name":"opinion5","display":getDes('opinion5'),"type":"text"},{"newline":false,"name":"PostName5","display":getDes('PostName5'),"type":"text"},{"newline":false,"name":"PostValues5","display":getDes('PostValues5'),"type":"text"},{"newline":false,"name":"PostDate5","display":getDes('PostDate5'),"type":"text"},{"newline":false,"name":"opinion6","display":getDes('opinion6'),"type":"text"},{"newline":false,"name":"PostName6","display":getDes('PostName6'),"type":"text"},{"newline":false,"name":"PostValues6","display":getDes('PostValues6'),"type":"text"},{"newline":false,"name":"PostDate6","display":getDes('PostDate6'),"type":"text"},{"newline":false,"name":"opinion7","display":getDes('opinion7'),"type":"text"},{"newline":false,"name":"PostName7","display":getDes('PostName7'),"type":"text"},{"newline":false,"name":"PostValues7","display":getDes('PostValues7'),"type":"text"},{"newline":false,"name":"PostDate7","display":getDes('PostDate7'),"type":"text"}]
	});
         pb.loadUrlData();
